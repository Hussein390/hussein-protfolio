export const projects = [
  ...
  },
  {
    ...
    {
        proName: "ManyInOne",
        descaription: 'This websit has many projects.',
        gitUrl: 'https://github.com/Hussein390/Many-In-One/',
        liveUrl: 'https://many-in-one.vercel.app/',
        img: '/assets/manyinone.png',
        tags:['TypeScript', 'Tailwindcss','ReactJs']
      },
      {
        proName: "Movie",
        descaription: 'A Site for Searching for Movies.',
        gitUrl: 'https://github.com/Hussein390/Search_Movie',
        liveUrl: 'https://search-movie-theta.vercel.app/',
